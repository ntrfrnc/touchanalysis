...
(function (dpd, List, Papa, Highcharts) {
  ...
  dpd[dataName].get(function (data, err) {
    ...
    var itemTemplate = '<li><h3 class="id"></h3> <div class="info-wrapper">' +
            '<span class="label">Gender: </span><span class="gender"></span>\n' +
            '<span class="label">Position: </span><span class="position"></span>\n' +
            '<span class="label">Hand: </span><span class="hand"></span>\n' +
            '<span class="label">Desired BPM: </span><span class="desiredBPM"></span>\n' +
            '</div></li>';

    var options = {
      valueNames: ['id', 'gender', 'position', 'hand', 'desiredBPM'],
      item: itemTemplate
    };
...
/**
 * Synchronize charts pointer
 */
var chartsContainer = document.getElementById('charts-container');
chartsContainer.addEventListener('mousemove', function (e) {
  var chart,
      point,
      i,
      event;
